...
Feature: Composing the text and sharing the message to your friends and followers in android device
  ...
  Scenario Outline: Using Composer, compose some text on Text tool
    ...
    When I click on "firstPersonConversation" with xpath
    And I click on "shareWithYourFriends"
    When I click on "firstPersonhomepage" with xpath
    Then I check "yublConversationText" with "composingText" on receiverPage
